	   ...
	   /* CUSTOM NOTIFICATION */
		...
		/* DATA TABLES */
			...
			function init_DataTables() {
				...
				$('#datatable_carros_por_periodo').DataTable({
                    ajax:{url:'/lista_carros_por_periodo' ,dataSrc:"", type: 'GET'},
                    columns: [

                        {"data": "id" },
                        {"data": "fechaCierrePedido" },
                ...
                var table = $('#datatable_carros').DataTable({"order": [[ 1, "desc" ]],
                        "iDisplayLength": 50});
