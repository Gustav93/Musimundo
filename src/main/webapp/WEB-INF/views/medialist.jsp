                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="total" class="count">${mediaReport.countTotal}</div>
                                            <h3>Procesados Correctamente</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="procesados" class="count">${mediaReport.countOk}</div>
                                            <h3>Procesados Correctamente</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="procesadosConWarning" class="count">${mediaReport.countWarning}</div>
                                            <h3>Procesados con Warning</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="procesadosConError" class="count">${mediaReport.countError}</div>
                                            <h3>Procesados con Error</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="noProcesados" class="count">${mediaReport.countNotProcessed}</div>
                                            <h3>No Procesados</h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable_carros" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Code Media</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Is Default</th>
                                    ...
                                    <c:forEach items="${mediaList}" var="media">
                                        <tr role="row">
                                            <td>${media.productCode}</td>
                                            <td>${media.codeMedia}</td>
                                            <td>${media.isDefault}</td>
                                            <td>${media.importOrigin}</td>
                                            <td>${media.processingDate}</td>
                                            <td>${media.feedStatus}</td>
                                            <td>${media.errorDescription}</td>
                                            <td>${media.company}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
