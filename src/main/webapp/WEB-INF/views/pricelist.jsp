                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="total" class="count">${priceReport.countTotal}</div>
                                            <h3>Procesados Correctamente</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="procesados" class="count">${priceReport.countOk}</div>
                                            <h3>Procesados Correctamente</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="procesadosConWarning" class="count">${priceReport.countWarning}</div>
                                            <h3>Procesados con Warning</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="procesadosConError" class="count">${priceReport.countError}</div>
                                            <h3>Procesados con Error</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <div class="tile-stats">
                                            <div id="noProcesados" class="count">${priceReport.countNotProcessed}</div>
                                            <h3>No Procesados</h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable_carros" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Currency</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Online Price</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Store Price</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Has Priority</th>
                                    ...
                                    <c:forEach items="${priceList}" var="price">
                                        <tr role="row">
                                            ...
                                            <td>${price.onlinePrice}</td>
                                            <td>${price.storePrice}</td>
                                            <td>${price.hasPriority}</td>
                                            <td>${price.importOrigin}</td>
                                            <td>${price.processingDate}</td>
                                            <td>${price.feedStatus}</td>
                                            <td>${price.errorDescription}</td>
                                            <td>${price.company}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
