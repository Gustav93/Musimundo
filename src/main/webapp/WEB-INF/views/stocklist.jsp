                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable_carros" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Stock</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Warehouse</th>
                                        <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 155px;" aria-label="Position: activate to sort column ascending">Status</th>
                                    ...
                                    <c:forEach items="${stockList}" var="stock">
                                        <tr role="row">
                                            ...
                                            <td>${stock.status}</td>
                                            <td>${stock.importOrigin}</td>
                                            <td>${stock.processingDate}</td>
                                            <td>${stock.feedStatus}</td>
                                            <td>${stock.errorDescription}</td>
                                            <td>${stock.company}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
